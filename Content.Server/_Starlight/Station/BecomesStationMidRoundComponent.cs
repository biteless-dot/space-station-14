...
public sealed partial class BecomesStationMidRoundComponent : Component
{
    ...
    /// <summary>
    /// Allows the salvage shuttle to spawn
    /// </summary>
    [DataField] public bool AllowSalvageShuttle;
    /// <summary>
    /// Allows the mining shuttle to spawn
    /// </summary>
    [DataField] public bool AllowMiningShuttle;
    /// <summary>
