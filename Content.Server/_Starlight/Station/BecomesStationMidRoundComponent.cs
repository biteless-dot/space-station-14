...
public sealed partial class BecomesStationMidRoundComponent : Component
{
    ...
    [DataField] public bool AllowSalvageShuttle; // allows the salvage shuttle to spawn or not.
    [DataField] public bool AllowMiningShuttle; // allows the mining shuttle to spawn or not.
